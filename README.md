...
- Product Analyst with hands-on experience at 
  [Langdock](https://langdock.com) — a Series A Enterprise AI 
  platform — where I worked on AI chat interface friction points 
  and user research for AI tools
  
- Business Growth Analyst at VOID — conducted market and 
  industry analysis across AI-driven domains including 
  healthcare, real estate, fitness, and B2B services

- Subgraph Engineer Intern at [The Graph](https://thegraph.com) 
  — indexed and queried blockchain data using GraphQL, deployed 
  complex subgraphs across DeFi protocols

- Protocol Grantee at [Gitcoin](https://gitcoin.co) — selected 
